...
import com.github.qpcrummer.elementalist.magic.spell_types.DelayedMultishotSpell;
...
public class IceAge extends DelayedMultishotSpell {
    public IceAge(ServerPlayerEntity player, World world) {
        super(player, world, "Ice Age", 800, 7, 0.65F, 0.0F, 0.0F, 4, 40);
    }
