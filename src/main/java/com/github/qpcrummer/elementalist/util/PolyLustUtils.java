package com.github.qpcrummer.elementalist.util;// Created 2022-13-07T01:12:20
...
import static com.github.qpcrummer.elementalist.Elementalist.modid;
...
public class PolyLustUtils {
    ...
    /**
     * Helper method to register an item for Elementalist.
     *
     * @param path The path of the item in the registry.
